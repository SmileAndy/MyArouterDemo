...
public final class Prefs {
    ...
    /**
     * Retrieves a stored Object value.
     * @param key      The name of the preference to retrieve.
     * @param classOfT The Object value's class.
     * @param <T>      The class type of the classOfT.
    ...
    /**
     * Stores a object as json
     * @param key The name of the preference to modify
     * @param object The object that will turn into json.
     *               Please notify that the Object must be a POJO
